...
define([
	...
	"dojo/text!./html/content.html", "dojo/text!./html/selectGroups.html", "dojo/text!./html/selectGroup1.html", './js/esriapi', './js/clicks', 'dojo/_base/lang'	
],
function ( 	declare, PluginBase, ContentPane, dom, domStyle, domGeom, obj, content, selGroups, selGroup1, esriapi, clicks, lang ) {
	return declare(PluginBase, {
		// The height and width are set here when an infographic is defined. When the user click Continue it rebuilds the app window with whatever you put in.
		toolbarName:"Regional Resilience Projects", showServiceLayersInLegend:true, allowIdentifyWhenActive:false, rendered:false, resizable:false,
		hasCustomPrint:false, size:'custom', width:'420', hasHelp:false, fullName:"Regional Resilience Projects",
		...
		initialize: function (frameworkParameters) {
			...
			this.url = "http://services.coastalresilience.org:6080/arcgis/rest/services/Connecticut/Regional_Resilience_Projects_v2/MapServer";
			this.layerDefs = [];
		},
